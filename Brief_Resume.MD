...
- **Programming** – Python, SQL, Java, Node.js, Next.js, TypeScript, C#  
...
- Built **vizly.ai**, a GenAI SaaS product for enterprises, achieving **record time-to-market**.  
- Built *PathGnos* for Mayo Clinic (Azure-based pathology archive).  
